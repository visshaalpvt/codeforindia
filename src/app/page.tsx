...
const features = [
  { icon: Shield, title: "Investigation Command", desc: "Field operations, suspect tracking, witness management, and live crime scene mapping with IoT sensor integration.", color: "text-cyan-400", bg: "bg-cyan-500/10" },
  { icon: Microscope, title: "Forensic Science Lab", desc: "AI-powered autopsy, toxicology screening, DNA profiling, wound analysis, and entomology-based time-of-death estimation.", color: "text-amber-400", bg: "bg-amber-500/10" },
  { icon: Brain, title: "Intelligence Analytics", desc: "Neural risk scoring, behavioral profiling, cross-case link discovery, anomaly detection, and predictive threat modeling.", color: "text-purple-400", bg: "bg-purple-500/10" },
];
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0B1020] text-white overflow-hidden">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#0B1020]/80 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center">
              <Shield className="w-4 h-4 text-cyan-400" />
            </div>
            <span className="text-lg font-bold font-['Space_Grotesk'] tracking-tight text-white">AIVENTRA</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#dashboards" className="text-sm text-gray-400 hover:text-white transition-colors">Dashboards</a>
          </div>
          <Link
            href="/login"
            className="px-5 py-2 rounded-xl bg-cyan-500 text-white text-sm font-bold hover:bg-cyan-400 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)]"
          >
            Access System →
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
              ...
              <span className="text-[11px] font-bold text-cyan-400 uppercase tracking-widest">Government Forensic Intelligence Platform</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/login"
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-cyan-500 text-white font-bold text-sm hover:bg-cyan-400 transition-all shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:shadow-[0_0_40px_rgba(6,182,212,0.5)]"
              >
                Access System <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="#features"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl border border-white/10 text-gray-300 font-medium text-sm hover:bg-white/5 transition-all"
              >
      ...
      <section id="dashboards" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[11px] font-bold text-cyan-400 uppercase tracking-[0.3em] mb-3">3 Specialized Workspaces</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white font-['Space_Grotesk'] tracking-tight">Role-Based Dashboards</h2>
            <p className="text-gray-500 mt-3 max-w-lg mx-auto text-sm">Each dashboard is purpose-built for a specific forensic role with dedicated tools, AI models, and data views.</p>
          </div>
      ...
      <section id="capabilities" className="py-20 px-6 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[11px] font-bold text-amber-400 uppercase tracking-[0.3em] mb-3">Core Technology</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white font-['Space_Grotesk'] tracking-tight">Platform Capabilities</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((cap, i) => (
              <motion.div
                ...
                className="p-6 rounded-2xl border border-white/5 hover:bg-white/[0.02] transition-all group"
              >
                <cap.icon className="w-6 h-6 text-cyan-400 mb-4 group-hover:scale-110 transition-transform" />
                <h4 className="text-sm font-bold text-white mb-2 uppercase tracking-wide">{cap.title}</h4>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white font-['Space_Grotesk'] tracking-tight mb-4">
            Ready to Begin Analysis?
          </h2>
          <p className="text-gray-400 mb-8">Access the forensic intelligence system with your role-based credentials.</p>
          <Link
            href="/login"
            className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-cyan-500 text-white font-bold hover:bg-cyan-400 transition-all shadow-[0_0_30px_rgba(6,182,212,0.3)]"
          >
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-600">AIVENTRA Forensic Intelligence System</span>
          </div>
